  ...
  <div class="card">
    <div class="header-row">
      <div class="avatar-stack">
        ...
        <form class="pfp-form" method="post" action="<c:url value='/participant/profile/change-pfp' />" enctype="multipart/form-data">
          <input type="hidden" name="_csrf" value="${_csrfToken}">
          <input id="participantPfpInput" class="pfp-file" type="file" name="profilePic" accept="image/*" required>
          <button class="pfp-btn" type="button" aria-label="Change profile picture" onclick="document.getElementById('participantPfpInput').click();">
